...
/**
*/
class GottaGetAGripverbAudioProcessor  : public juce::AudioProcessor
{
public:
    //==============================================================================
    GottaGetAGripverbAudioProcessor();
    ~GottaGetAGripverbAudioProcessor() override;
...
private:
    //==============================================================================
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (GottaGetAGripverbAudioProcessor)
